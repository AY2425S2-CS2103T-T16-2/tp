...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 visitors without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("The application size should not be more than 100mb to enable user to have easy installation on various devices.")]),_v(" "),_c('li',[_v("The application should also be optimized such that its CPU and memory usage is low so that it can run on low end machine.")]),_v(" "),_c('li',[_v("The system should be optimised for a single-user operation instead of multiple user operation.")]),_v(" "),_c('li',[_v("The application should not crash during network failure and be reliable enough for continuous use case during operation hours.")]),_v(" "),_c('li',[_v("The data used should be stored in structured and human-readable format like JSON.")]),_v(" "),_c('li',[_v("Should be easily extendable so that new features can be added without having to refactor the entire project.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Wed, 19 Mar 2025, 23:29:31 GMT+8]")])])])}
}];

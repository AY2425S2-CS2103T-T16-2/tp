...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("InnSync")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AirBnB Host")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The input format is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. InnSync shows an error message and informs the user of the proper format.")]),_v(" "),_c('li',[_v("Use case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_v("2b. The person already exists in InnSync.")]),_v(" "),_c('ul',[_c('li',[_v("2b1. InnSync shows an error message and informs the user that the person already exists.")]),_v(" "),_c('li',[_v("Use case resumes at step 1.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("1a. The given index is invalid.\n"),_c('ul',[_c('li',[_v("1a1. InnSync shows an error message and informs the user that the index is invalid.")]),_v(" "),_c('li',[_v("Use case resumes at step 1.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. InnSync shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("4a. The given arguments are invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("4a1. InnSync shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The given name is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. InnSync shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("2a. The list is empty.\n"),_c('ul',[_c('li',[_v("2a1. InnSync shows a message indicating that the list is empty.")]),_v(" "),_c('li',[_v("Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Sat, 8 Mar 2025, 17:48:38 GMT+8]")])])])}
}];
